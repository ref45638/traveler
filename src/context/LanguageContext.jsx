...
const translations = {
  "zh-TW": {
    ...
    saveNote: "儲存筆記",
    noNotes: "還沒有筆記喔！",
    tapToAddNote: "點擊 + 新增一個吧",
    deleteNoteConfirm: "確定要刪除這個筆記嗎？",
    placeholderNoteTitle: "例如：航班資訊",
    placeholderNoteContent: "航班號碼、訂位代號、住宿地址...",
    // Profile
    logout: "登出",
    deleting: "刪除中...",
    deleteAccount: "刪除帳號",
  ...
  en: {
    ...
    tapToAddNote: "Tap + to add one",
    deleteNoteConfirm: "Delete this note?",
    placeholderNoteTitle: "e.g. Flight Info",
    placeholderNoteContent: "Flight number, booking code, hotel address...",
    // Profile
    logout: "Logout",
    deleting: "Deleting...",
